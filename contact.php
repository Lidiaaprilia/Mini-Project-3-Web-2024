...
if(isset($_POST['send'])){
    ...
    // Kirim data ke JavaScript untuk disimpan di local storage
    echo "<script>";
    echo "localStorage.setItem('name', '$name');";
    echo "localStorage.setItem('email', '$email');";
    echo "localStorage.setItem('number', '$number');";
    echo "localStorage.setItem('message', '$msg');";
    echo "</script>";
}
